...
public class TestConfig{
    ...
    public static String[] to ={"aloksenapati45@gmail.com","trainer@way2automation.com"};
    ...
    public static String mysqlpassword = "Alok@1234";
    public static String mysqlurl = "jdbc:mysql://localhost:3306/24thaug2019";
